...
def clusterData(fileName, artist):
    ...
    MyFile = open(fileName + 'TrackDataClustered.csv','w')
    ...
    print('\nSaved as ' + fileName + 'TrackDataClustered.csv')
...
def recommendSongs(artist, favSongs):
    ...
    df = pd.read_csv(fileName + 'TrackDataClustered.csv', encoding = "latin-1")
...
fileName = 'C:\\Users\\faiza\\OneDrive\\Desktop\\' + rawArtistName
